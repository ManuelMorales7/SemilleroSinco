...
<!DOCTYPE html>
 <html lang="en" dir="ltr">
   <head>
     ...
     <title>Eliminar Subcapitulos</title>
   ...
   <body>
     <center>
       ...
       <div class="agregacion">
         ...
         <br><br>
           <h3 class="title">Eliminacion de subcapitulos</h3>
           <br><br>
           ...
           <br><br><br>
           <button type="button" name="button" id="eliminar" class="uno">Eliminar subcapitulo</button>
